package net.danielwind.effcaching.chapter6.impl;
...
import net.danielwind.effcaching.chapter6.cache.CacheDelegate;
import net.danielwind.effcaching.chapter6.domain.Employee;
import net.danielwind.effcaching.chapter6.domain.EmployeeList;
import net.danielwind.effcaching.chapter6.utils.XMLUtil;
