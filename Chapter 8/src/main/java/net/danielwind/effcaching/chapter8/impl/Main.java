package net.danielwind.effcaching.chapter8.impl;
...
import net.danielwind.effcaching.chapter8.cache.CacheDelegate;
import net.danielwind.effcaching.chapter8.domain.Item;
import net.danielwind.effcaching.chapter8.domain.ItemList;
import net.danielwind.effcaching.chapter8.domain.Menu;
import net.danielwind.effcaching.chapter8.utils.XMLUtil;
